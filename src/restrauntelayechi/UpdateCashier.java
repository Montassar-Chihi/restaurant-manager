...
public class UpdateCashier extends javax.swing.JFrame {
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        try {
            ...
            String name_cash =namefield.getText();
            String phone_cash =phonefield.getText();
            String password_cash = passfield.getText();
            if (name_cash.equals("") || phone_cash.equals("") || password_cash.equals("") ){
                 JOptionPane.showMessageDialog(this, "Please fill all fields to update the Cashier info");
            }else{
                try{
                    String query="Update users set name = ? , phone = ? , password = ? where phone = ? and role = 'cashier' ";
                    pst = conn.prepareStatement(query);
                    pst.setString(1, name_cash);
                    pst.setString(2,phone_cash);
                    pst.setString(3,password_cash);
                    pst.setString(4,phone.getText());
                    pst.executeUpdate();
                    JOptionPane.showMessageDialog(this, name_cash + " Updated");
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        try {
            ...
            String query="select * from users where phone="+phone_number+" and role = 'cashier' ";
            pst=conn.prepareStatement(query);
            rs=pst.executeQuery();
            if (rs.next()){
